<form action="/admin/filter/<?php echo $filter['filter_id']?>" method="post">
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="form-group">
        ...
        <div class="btn-group" data-toggle="buttons">
          <label class="btn btn-default <?php if ($filter['filter_type'] == 1): ?>active<?php endif ?>">
            <input type="radio" name="options" value="1" autocomplete="off" <?php if ($filter['filter_type'] == 1): ?>checked<?php endif ?>> <?php echo $app->lang->get('Numeric')?>
          </label>
          <label class="btn btn-default <?php if ($filter['filter_type'] == 2): ?>active<?php endif ?>">
            <input type="radio" name="options" value="2" autocomplete="off" <?php if ($filter['filter_type'] == 2): ?>checked<?php endif ?>> <?php echo $app->lang->get('OR')?>
          </label>
          <label class="btn btn-default <?php if ($filter['filter_type'] == 3): ?>active<?php endif ?>">
            <input type="radio" name="options" value="3" autocomplete="off" <?php if ($filter['filter_type'] == 3): ?>checked<?php endif ?>> <?php echo $app->lang->get('AND')?>
          </label>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="filter[id]" value="<?php echo $filter['filter_id']?>">
